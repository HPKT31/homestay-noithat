					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>Liên hệ</h1>
								<p class="mb-4">Liên hệ với chúng tôi để được giải đáp thắc mắc của bạn.</p>
							</div>
						</div>
						<div class="col-lg-7">
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-md-8 col-lg-8 pb-4">
              ...
              <div class="row mb-5">
                ...
                <div class="col-lg-4">
                  <div  class="service no-shadow align-items-center link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
                    ...
                    <div class="service-contents">
                      <p>khoa089204000108@gmail.com</p>
                    </div> <!-- /.service-contents-->
                  </div> <!-- /.service -->
                </div>
              ...
              <form action="index.php?page=add" method="post">
                ...
                <div class="form-group">
                  <label class="text-black" for="email">Email của bạn</label>
                ...
                <input type="submit" class="btn btn-primary-hover-outline" name="add" value="Gửi">
              </form>
