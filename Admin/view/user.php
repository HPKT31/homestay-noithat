      ...
      <div class="tile">
        <div class="tile-body">
          <div class="row element-button">
            <div class="col-sm-2">
              <a class="btn btn-add btn-sm" href="index.php?page=themuser" title="Thêm"><i class="fas fa-plus"></i>
                ...
                foreach ($kq as $user) {
                  echo '
                          <tr>
                            ...
                            <td>' . $user['id'] . '</td>
                            <td>' . $user['ten'] . '</td>
                            <td><img class="img-card-person" src="../uploads/' . $user['img'] . '" alt=""></td>
                            <td>' . $user['email'] . '</td>
                            <td>' . $user['taik'] . '</td>
                            <td>' . $user['sdt'] . '</td>
                            <td class="table-td-center">
                            <button  class="btn btn-primary btn-sm trash" type="button" data-id="' . $user['id'] . '" title="Xóa">
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static"
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <form id="editForm" method="post" action="index.php?page=upduser" enctype="multipart/form-data"
    ...
    jQuery(".trash").click(function () {
      ...
      swal({
        ...
        if (willDelete) {
          ...
          // Giả sử ID người dùng được lưu trong thuộc tính data

          // Gọi AJAX để xóa người dùng thông qua PHP
          jQuery.ajax({
            type: 'GET',
            url: 'index.php?page=xoa&id=' + ids,
            data: { ids: ids },
